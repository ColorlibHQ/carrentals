...
class CarRentals_Enqueue {

	public $scripts = array();

	public function carrentals_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'carrentals_frontend_enqueue_scripts', ) );
	}

	public function carrentals_frontend_enqueue_scripts( ) {
