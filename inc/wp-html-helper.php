...
// image default alt
if( ! function_exists( 'carrentals_img_default_alt' ) ) {
	function carrentals_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'carrentals_img_tag' ) ) {
	function carrentals_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = carrentals_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'carrentals_anchor_tag' ) ) {
	function carrentals_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'carrentals' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'carrentals_heading_tag' ) ) {
	function carrentals_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'carrentals' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'carrentals_paragraph_tag' ) ) {
	function carrentals_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'carrentals_other_tag' ) ) {
	function carrentals_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'carrentals_button_element ' ) ) {
	function carrentals_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'carrentals' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
